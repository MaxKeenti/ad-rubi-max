...
> snapshot lives in `docs/implementation_plan.md`.
...
`docs/tasks/`. The "why" behind decisions lives here.
...
**(F2)** — task files live in `docs/tasks/`. Each file is a thin
...
| Why a decision was made | `docs/adr/` + `docs/grilling-session-2026-05-26.md` |
| The component-level implementation plan | `docs/implementation_plan.md` |
| What ships to the professor | `docs/entrega/` |
| The detailed work plan and task files | this document + `docs/tasks/` |

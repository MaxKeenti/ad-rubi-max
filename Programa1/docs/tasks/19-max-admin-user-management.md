...
- `docs/CONTEXT.md` § "Account creation"
- `docs/entrega/02-requerimientos/content.md` § 3.1.1
- `docs/entrega/04-modelo-de-datos/content.md` § `users`
- `docs/entrega/06-glosario/content.md` § "Creación de cuentas"
- `app/src/main/java/com/example/mangos/data/repository/AuthRepository.kt`
- `app/src/main/java/com/example/mangos/data/repository/firestore/AuthRepositoryFirestoreImpl.kt`
- `firestore.rules`

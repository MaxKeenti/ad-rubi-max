...
- `docs/entrega/04-modelo-de-datos/content.md` § 2.3 (full schema, three timestamps, dateKey)
- `docs/entrega/06-glosario/content.md` (Purchase, denormalization rules)
- `docs/adr/0002-server-side-authz.md` (rules constrain what queries are valid)

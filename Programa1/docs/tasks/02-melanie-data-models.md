...
- `docs/entrega/04-modelo-de-datos/content.md` § 2 (all three collections)
- `docs/entrega/06-glosario/content.md` (semantics of each field)
- `app/src/main/java/com/example/mangos/data/repository/*.kt` (interfaces already reference these classes — check the signatures Max drafted)

## Outputs

In `app/src/main/java/com/example/mangos/data/model/`:

...
- `docs/entrega/04-modelo-de-datos/content.md` § 2.1 (users schema)
- `docs/entrega/06-glosario/content.md` § "Política de autorización"
- `app/src/main/java/com/example/mangos/data/repository/AuthRepository.kt` (interface)
- `app/src/main/java/com/example/mangos/data/model/User.kt`, `UserRole.kt`

...
- `app/src/main/java/com/example/mangos/data/repository/*.kt` (the interfaces from `00-max-draft-interfaces`)
- `docs/entrega/06-glosario/content.md` (for seed data — what an UNREGISTERED supplier looks like, what realistic suppliers look like)

## Outputs

### `app/src/main/java/com/example/mangos/data/repository/fake/`
...
### `app/src/main/java/com/example/mangos/data/di/AppModule.kt`

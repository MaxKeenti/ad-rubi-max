...
- `docs/entrega/04-modelo-de-datos/content.md` § 2 (collections to create)
- `docs/entrega/06-glosario/content.md` (domain terms — useful when naming things in the Console)
- `docs/adr/0002-server-side-authz.md` (won't deploy rules yet, but read to know what you're building toward)
...
- `app/google-services.json` — downloaded from the Firebase Console, committed to the repo.
...
- [ ] Melanie can pull the branch and the file lives at `app/google-services.json`.

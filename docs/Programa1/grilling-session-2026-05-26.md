...
**Starting point:** `docs/Programa1/implementation_plan.md` (original 16h-estimate plan)
**Outputs:**
- `docs/Programa1/CONTEXT.md` — full domain glossary
- `docs/Programa1/adr/0001-personal-device-auth.md`
- `docs/Programa1/adr/0002-server-side-authz.md`
- `docs/Programa1/implementation_plan.md` — rewritten to reflect decisions
- This log

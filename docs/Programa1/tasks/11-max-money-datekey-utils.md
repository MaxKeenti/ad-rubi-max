...
- `docs/Programa1/entrega/06-glosario/content.md` § "Money" and § "`dateKey` — el campo bucket-por-día"
- `docs/Programa1/entrega/04-modelo-de-datos/content.md` § 2.3 (Purchase fields) and § 5 (Money: `Long centavos`)

## Outputs

### `Programa1/app/src/main/java/com/example/mangos/data/util/MoneyFormatter.kt`
...
### `Programa1/app/src/main/java/com/example/mangos/data/util/DateKey.kt`
...
### `Programa1/app/src/test/java/com/example/mangos/data/util/MoneyFormatterTest.kt`
...
### `Programa1/app/src/test/java/com/example/mangos/data/util/DateKeyTest.kt`

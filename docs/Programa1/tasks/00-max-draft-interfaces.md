...
- `docs/Programa1/entrega/04-modelo-de-datos/content.md` (schemas)
- `docs/Programa1/entrega/06-glosario/content.md` (domain terms)
- `docs/Programa1/implementation_plan.md` Component 3 (Data Layer — repository methods listed)
- `docs/Programa1/adr/0002-server-side-authz.md` (what queries the rules allow)
...
### `Programa1/app/src/main/java/com/example/mangos/data/model/`
...
### `Programa1/app/src/main/java/com/example/mangos/data/repository/`

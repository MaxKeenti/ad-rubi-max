...
- `docs/Programa1/entrega/02-requerimientos/content.md` § 3.4 (Dashboard) and § 3.5 (Reports nav)
- `docs/Programa1/implementation_plan.md` Component 10
- `Programa1/app/src/main/java/com/example/mangos/data/repository/AuthRepository.kt` (currentUser StateFlow for conditional routing)

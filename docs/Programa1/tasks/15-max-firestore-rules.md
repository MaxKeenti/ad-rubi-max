...
- `docs/Programa1/adr/0002-server-side-authz.md` (full policy)
- `docs/Programa1/entrega/03-arquitectura/content.md` § 5 (rules summary)
...
- `firebase.json` at the repo root (if not present) with:
  ```json

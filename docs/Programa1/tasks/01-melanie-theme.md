...
- `docs/Programa1/implementation_plan.md` Component 2 (palette description: rich green primary, warm mango orange secondary, golden yellow tertiary)
- Current files: `Programa1/app/src/main/java/com/example/mangos/ui/theme/{Color,Theme,Type}.kt` (Compose defaults)

...
# Firestore rules tests, from repo root
firebase emulators:exec --only firestore "npm --prefix tests/rules test"

# Firebase Functions TypeScript build, from repo root
...
The formal deliverables live in `docs/Programa1/entrega/`.
...
- `Programa1/app/google-services.json` identifies the Firebase project for the
